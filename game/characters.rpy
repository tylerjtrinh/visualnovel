...
image side alex awksmile = Transform(im.Scale("sprites/alex/alex_awksmile.png",   400, 500), xalign=0.12, yalign=1.0, anchor=(0.5, 1.0))
image side alex slightsmile = Transform(im.Scale("sprites/alex/alex_smileslight.png",   400, 500), xalign=0.12, yalign=1.0, anchor=(0.5, 1.0))
